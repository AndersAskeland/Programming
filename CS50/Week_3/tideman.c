...
bool vote(int rank, string name, int ranks[])
{
    for (int i = 0; i < strlen(candidate_count); i++) // Uses ranks as I want to loop it only for the number of possible ranks.
    {
...
// Update global preference variable, preferences given one voter's ranks
void record_preferences(int ranks[])
{
    int j = 0;
